...
$(document).ready(function () {
    $("#UNIT").change(function () {
        ...
        if (val === "Kharn the Betrayer") {
            ...
            $("#UNIT_WEAPON").html("<option value='Havoc Launcher'>Havoc Launcher</option><option value='Twin Lascannon'>Twin Lascannon</option><option value='Twin Heavy Bolter'>Twin Heavy Bolter</option><option disabled>─────Combi Weapons─────</option><option value='Combi-bolter'>Combi-bolter</option><option value='Combi-flamer'>Combi-flamer</option><option value='Combi-melta'>Combi-melta</option><option value='Combi-plasma'>Combi-plasma</option><option value='Supercharged Combi-plasma'>Supercharged Combi-plasma</option>");
        } 
    });
});        
</script>
